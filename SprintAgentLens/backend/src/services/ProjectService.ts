...
export class ProjectService {
  ...
  private static canReadProject(user: AuthenticatedUser, project: any): boolean {
    // Debug logging to understand permission failure
    console.log('=== ProjectService.canReadProject DEBUG ===');
    console.log('User:', { id: user.id, role: user.role, workspaceId: user.workspaceId });
    console.log('UserRole.ADMIN:', UserRole.ADMIN);
    console.log('user.role === UserRole.ADMIN:', user.role === UserRole.ADMIN);
    console.log('Project:', { id: project.id, workspaceId: project.workspaceId });
    console.log('project.workspaceId === user.workspaceId:', project.workspaceId === user.workspaceId);
    ...
    const canAccess = project.workspaceId === user.workspaceId;
    console.log('Access result for non-admin:', canAccess);
    console.log('=== ProjectService.canReadProject DEBUG END ===');
    return canAccess;
  }
