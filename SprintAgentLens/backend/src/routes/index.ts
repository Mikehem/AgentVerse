...
export async function registerRoutes(server: FastifyInstance): Promise<void> {
  try {
    ...
    await server.register(async function v1Routes(server) {
      ...
      // Datasets routes - PHASE 2B IMPLEMENTED ✅ - Temporarily disabled due to schema issues
      ...
      // Agents routes - IMPLEMENTED ✅
      await server.register(import('@/controllers/agents'), {
        prefix: '/v1/private/agents',
      });

      // Traces routes - IMPLEMENTED ✅
